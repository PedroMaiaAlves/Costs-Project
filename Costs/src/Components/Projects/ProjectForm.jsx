...
function ProjectForm({ handleSubmit ,btnText, projectData}) {
    ...
    return (
        <form onSubmit={submit} className={styles.form}>
            ...
            <Input type="number" text="Orçamento do projeto" name="budget" placeholder="Insira o orçamento total do projeto" handleOnChange={handleChange} value={project.budget ? project.budget: ''}></Input>
            <div>
